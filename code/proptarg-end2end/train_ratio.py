...
if __name__ == '__main__':
    ...
    tr_inp, tr_r_out = read_images(tr_inds, tr_size)
    v_inp, v_r_out = read_images(v_inds, v_size)
    learning_rate = 0.02
    nb_epochs = 1
    b_size = 85
    ...
    hist = model.fit(tr_inp, tr_r_out, batch_size = b_size, epochs = nb_epochs, validation_data = (v_inp, v_r_out), callbacks = callback_list)
